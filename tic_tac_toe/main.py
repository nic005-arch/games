...
class Game:
    ...
    def ask_names(self, gamemode=None):
        ...
        while True:
            ...
            if gamemode == 'pvp':
                ...
                label1 = font.render("Player :", True, BIANCO)
                screen.blit(label1, (input_box1.x - label1.get_width() - 10, input_box1.y + 10))
            ...
            if val and text1 and text2 or val and text1 and gamemode == 'ai':
                self.game_var = self.set_game_var()
                if self.game_var == 1 and gamemode == 'pvp':
                    self.player1_name = text1
                    self.player2_name = text2
                    self.start_pvp()
                    return  
                elif self.game_var == 1 and gamemode == 'ai':
                    self.player1_name = text1
                    self.start_ai()
                    return
